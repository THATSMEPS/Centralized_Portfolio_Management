...
const Login = () => {
    ...
    const { setAdminData, setIsSuperAdmin, setRole } = useContext(AuthContext);
    ...
    const login = async (e) => {
        ...
        console.log("DEBUG LOGIN: V2 - TOAST FIXED");
        ...
        try {
            ...
            loginCompany({
                ...
                .then((res) => {
                    ...
                    if (res.data.isOk) {
                        // CRITICAL: Clear old menu data from localStorage FIRST to prevent showing wrong menus
                        ...
                        // Store isSuperAdmin flag so AuthContext picks it up correctly
                        localStorage.setItem("isSuperAdmin", res.data.data.isSuperAdmin === true);
                        setAuthorization(res.data.token);

                        // Set admin data first so MenuContext can read it
                        setAdminData({ ...res.data.data });
                        // Explicitly set role and isSuperAdmin BEFORE fetchMenus
                        // so MenuContext reads the correct values in the same render
                        setRole(res.data.role);
                        setIsSuperAdmin(res.data.data.isSuperAdmin === true);

                        // Wait for menus to be fetched before navigating
                        // This prevents race condition where old menus show briefly
                        // Pass true to force refresh and bypass any cached menus
                        fetchMenus(true).then(() => {
                            navigate("/dashboard");
                        }).catch((error) => {
                            console.error("Error fetching menus:", error);
                            // Still navigate even if menu fetch fails
                            navigate("/dashboard");
                        });
                    } else {
                    ...
                    <>
                        <div className="text-center">
                            <h2
                                ...
                                style={{ color: "var(--vz-primary, var(--primary))", fontWeight: "700" }}
                            >
                                FORGOT PASSWORD
                            </h2>
                        ...
                        <div className="p-2 mt-4">
                            <div className="mb-3">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setForgotPasswordEmail(e.target.value.replace(/\s/g, ''))
                                    }
                ...
                return (
                    <>
                        <div className="text-center">
                            <h2
                                className="mobile-heading"
                                style={{ color: "var(--vz-primary, #004B96)", fontWeight: "700" }}
                            >
                                VERIFY OTP
                            </h2>
                            <p className="text-muted">
                                                    ...
                                                    <div className="p-2 mt-4">
                                                        ...
                                                        >
                                                            ...
                                                            <div className="form-check mb-2">
                                                                ...
                                                                >
                                                                    <i className="ri-map-pin-line me-1" style={{ color: "var(--vz-primary, #ffffffff)" }}></i>
                                                            ...
                                                            <div className="form-check">
                                                                ...
                                                                >
                                                                    <i className="ri-global-line me-1" style={{ color: "var(--vz-primary, #3D1E11)" }}></i>
                                                        ...
                                                        <div className="mt-4">
                                                            <Button
                                                                type="button"
                                                                className="w-100 fw-bold auth-btn-hover"
                                                                onClick={login}
                                                                disabled={
