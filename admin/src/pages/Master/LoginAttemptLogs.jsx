                ...
                if (row.latitude && row.longitude) {
                    ...
                    return (
                        <a
                            ...
                            style={{
                                color: "var(--vz-primary, var(--primary))",
                                textDecoration: "none",
                                display: "flex",
                                alignItems: "center",
                                gap: "4px"
                                    ...
                                    <Row className="mb-4">
                                        <Col md={3}>
                                            <div
                                                ...
                                                style={{ backgroundColor: "var(--neutralLight, #F9F7F2)", border: "1px solid var(--neutralLight, #F9F7F2)" }}
                                            >
                                                <div className="d-flex align-items-center">
                                                    <div
                                                        className="avatar-sm me-3"
                                                        style={{
                                                            backgroundColor: "rgba(var(--successRgb, 46 125 50), 0.15)",
                                                            borderRadius: "8px",
                                                            display: "flex",
                                                            alignItems: "center",
                                                    ...
                                                    >
                                                        <i className="ri-user-line" style={{ color: "var(--vz-success, var(--success, #2E7D32))", fontSize: "20px" }}></i>
                                                    </div>
                                                    <div>
                                        ...
                                        <Col md={3}>
                                            <div
                                                className="p-3 rounded"
                                                style={{ backgroundColor: "rgba(var(--secondary-rgb, 210,105,30), 0.15)", border: "1px solid var(--vz-secondary, var(--secondary))" }}
                                            >
                                                <div className="d-flex align-items-center">
                                                    <div
                                                        className="avatar-sm me-3"
                                                        style={{
                                                            backgroundColor: "var(--vz-secondary, var(--secondary))",
                                                            borderRadius: "8px",
                                                            display: "flex",
                                                            alignItems: "center",
                                                            justifyContent: "center",
                                                    ...
                                                    >
                                                        <i className="ri-error-warning-line" style={{ color: "var(--accent, #B89E97)", fontSize: "20px" }}></i>
                                                    </div>
                                                    <div>
                                        ...
                                        <Col md={3}>
                                            <div
                                                className="p-3 rounded"
                                                style={{ backgroundColor: "rgba(var(--successRgb, 46 125 50), 0.15)", border: "1px solid var(--vz-success, var(--success))" }}
                                            >
                                                <div className="d-flex align-items-center">
                                                    <div
                                                        className="avatar-sm me-3"
                                    ...
                                    <div className="table-responsive table-card">
                                        <DataTable
                                            ...
                                            striped
                                                ...
                                                headCells: {
                                                    style: {
                                                        backgroundColor: "var(--neutralLight, #F9F7F2)",
                                                        fontWeight: "600",
                                                    },
                                                },
                                            }}
