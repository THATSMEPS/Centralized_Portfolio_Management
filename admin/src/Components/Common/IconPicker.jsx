        ...
        <div className="icon-picker-wrapper mb-3">
            ...
            <Dropdown isOpen={dropdownOpen} toggle={toggle} className="w-100">
                    ...
                    style={{
                        ...
                        border: "1px solid var(--neutralLight, #F9F7F2)",
                ...
                >
                    <div
                        className="p-2"
                            ...
                            top: 0,
                            backgroundColor: "white",
                            borderBottom: "1px solid var(--neutralLight, #F9F7F2)",
                            zIndex: 1,
                        }}
                    >
                        <Input
                            ...
                            {filteredIcons.map((icon, index) => (
                                <DropdownItem
                                    ...
                                    style={{
                                        ...
                                        border:
                                            value === icon.class
                                                ? "2px solid var(--vz-success, var(--success))"
                                                : "1px solid transparent",
                                        backgroundColor:
                                            value === icon.class
                                                ? "rgba(var(--successRgb, 46 125 50), 0.15)"
                                                : "transparent",
                                        transition: "all 0.2s",
                                    }}
                                    onMouseEnter={(e) => {
