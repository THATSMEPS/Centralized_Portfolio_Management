...
/**
 * Reorder menu groups (bulk sequence update)
 * @param {Array} sequences - Array of objects {id, sequence}
 * @returns {Promise}
 */
export const reorderMenuGroups = async (sequences) => {
    return api.patch(ENDPOINTS.MENU_GROUPS.REORDER, { sequences });
};
