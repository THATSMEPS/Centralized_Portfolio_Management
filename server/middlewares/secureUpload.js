...
/**
 * Synchronous UUID v4 generator (drop-in replacement for `uuid.v4`):
 * - Uses `crypto.randomUUID()` when available (Node 14.17+/18+)
 * - Falls back to RFC-4122 compliant generation using `randomBytes`
 */
function uuidv4() {
