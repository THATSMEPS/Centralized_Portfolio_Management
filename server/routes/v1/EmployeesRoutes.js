...
const { createEmployee,
  ...
  getCurrentUser,
  resetPassword,
} = require("../../controllers/v1/EmployeeController.js");
// ============ SECURITY IMPORTS ============
const { authRateLimiter, searchRateLimiter, passwordResetRateLimiter } = require("../../middlewares/rateLimiter.js");
 ...
 *   post:
 *     summary: List all employees by store with pagination
 *     tags: [Employees]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     responses:
 *       200:
 *         description: Paginated list of employees by store
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/PaginatedResponse'
...
// Staff panel login — same guards, 403 if employee does not have STAFF role
router.post(
  "/auth/staff/login",
  authRateLimiter,
