const EmailForModels = require("../../models/EmailFor.js");
const EmailTemplateModels = require("../../models/EmailTemplate.js");

const createEmailFor = async (req, res) => {
  try {
...
const updateEmailFor = async (req, res) => {
  try {
...
const getEmailForById = async (req, res) => {
  try {
    const { emailForId } = req.params;
...
const listAllEmailFor = async (req, res) => {
  try {
...
const deleteEmailFor = async (req, res) => {
  try {
    const { emailForId } = req.params;
...
const listEmailForByParams = async (req, res) => {
  try {
