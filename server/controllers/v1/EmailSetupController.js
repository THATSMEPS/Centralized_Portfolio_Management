const EmailSetupModels = require("../../models/EmailSetup.js");
const EmailTemplateModels = require("../../models/EmailTemplate.js");

const createEmailSetup = async (req, res) => {
  try {
...
const updateEmailSetup = async (req, res) => {
  try {
...
const getEmailSetupById = async (req, res) => {
  try {
    const { emailSetupId } = req.params;
...
const listAllEmailSetup = async (req, res) => {
  try {
...
const deleteEmailSetup = async (req, res) => {
  try {
    const { emailSetupId } = req.params;
...
const listEmailSetupByParams = async (req, res) => {
  try {
